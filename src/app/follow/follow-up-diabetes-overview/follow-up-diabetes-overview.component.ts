...
@Component({
  selector: 'app-follow-up-diabetes-overview',
  templateUrl: './follow-up-diabetes-overview.component.html',
  styleUrls: ['./follow-up-diabetes-overview.component.css']
})

export class FollowUpDiabetesOverviewComponent implements OnInit {
  user;
  communityName = '';
  doctorName = '';
  patientName = '';
