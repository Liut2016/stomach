...
@Component({
  ...
  templateUrl: './hypertension-overview.component.html',
  styleUrls: ['./hypertension-overview.component.css']
})
export class HypertensionOverviewComponent implements OnInit {
  user;
  communityName = '';
  doctorName = '';
  patientName = '';
